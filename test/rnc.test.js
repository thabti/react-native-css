...
t.test("Test inheritance CSS",function(t){
  css.parse('./test/fixtures/style-inherit.css','./test/fixtures/style-inherit.js',false,true,true,function(data){
    register(data)
    console.log(matchRules([{e:'view',c:['test']},{e:'view',c:['test']},{e:'text',c:['hello']}]))
    console.log(matchRules([{e:'view',c:['test']},{e:'view',c:['test']},{e:'scrollview',c:['hello']}]))
    console.log(matchRules([{e:'view',c:['test']},{e:'view',c:['direct']},{e:'text',c:['hello']}]))
    console.log(matchRules([{e:'view',c:['test']},{e:'view',c:['direct']},{e:'view',c:['test']},{e:'text',c:['hello']}]))
